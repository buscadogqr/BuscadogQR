    ...
    return (
        <div class="mx-10">
            ...
            <div class="flex flex-row gap-x-5 m-4">
                ...
                <h3 class="text-titles text-2xl font-bold">¿Qué es BuscadogQR?</h3>
            </div>
            ...
            <h3 class="text-third text-xl font-bold m-4 mt-0">¡<button onClick={(e) => goToRegister(e)} class="underline underline-offset-4">Unite</button> a la comunidad de BuscadogQR!</h3>
        </div>
    )
};
