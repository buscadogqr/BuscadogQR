            ...
            <nav class="bg-buscabrown border-gray-200 w-full z-30 top-0 md:h-20 sm:h-fit">
                <div class="flex flex-wrap justify-between items-center mx-auto px-4 md:px-6 py-2.5 max-w-screen-xl">
                    <div class="flex items-center">
                        <img src={logo} class="h-14 min-h-0 md:min-h-full mr-3" alt="BuscadogQR"/>
                        <div class="flex items-center">
                            <ul class="flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                                <li>
                                    <Link to="/home">
                                        <h class="text-gray-900 dark:text-white hover:underline" aria-current="page">Home</h>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/about">
                                        <h class="text-gray-900 dark:text-white hover:underline">Sobre nosotros</h>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/contact">
                                        <h class="text-gray-900 dark:text-white hover:underline">Contactanos</h>
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/ourStories">
                                        <h class="text-gray-900 dark:text-white hover:underline">Nuestras historias</h>
                                    </Link>
                                </li>
                                {checkLocalStorage() && (
                                    <li>
                                        <Link to="/subscribe">
                                            <h class="text-gray-900 dark:text-white hover:underline">Suscribite</h>
                                        </Link>
                                    </li>
                                )}
                                {!!user.length && user.type === "Admin" && (
                                    <li>
                                        <Link to="/admin">
                                            <h class="text-gray-900 dark:text-white hover:underline">Admin</h>
                                        </Link>
                                    </li>
                                )}
                            </ul>
                    ...
                    {!checkLocalStorage() && (
                        <div class="flex items-center gap-x-4 bg-buscabrown md:w-auto sm:w-max md:justify-center sm:justify-end">
                    ...
                    {checkLocalStorage() && (
                        <div class="flex items-center gap-x-4 text-white sm:ml-32">
