    ...
    return (
        <div class="flex justify-center m-20 mt-16 items-center border-4 border-buscabrown rounded-3xl p-10 w-fit self-center bg-gray-100 drop-shadow-2xl">
            ...
            <div class="flex flex-col">
                ...
                <div class="grid grid-cols-3 mt-14 gap-x-5">
                    <div class="flex flex-row gap-x-5 bg-titles text-white border border-2 border-titles rounded-xl p-2 hover:border-green-900 hover:bg-green-900 cursor-pointer" onClick={(e) => goTo(e, "editProfile")}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="flex flex-row gap-x-5 bg-titles text-white border border-2 border-titles rounded-xl p-2 hover:border-green-900 hover:bg-green-900 cursor-pointer" onClick={(e) => handleLogout(e)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="flex flex-row gap-x-5 text-white border border-2 border-red-900 rounded-xl p-2 hover:bg-red-700 hover:border-red-700 cursor-pointer bg-red-900" onClick={confirmDeletion}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div id='myModal' className='modal'>
                        <div>
                            <div>
                                ...
                                <button onClick={cancelDeletion}>Cancelar X</button>
                            </div>
                        </div>
                    </div>
