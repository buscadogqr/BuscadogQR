            ...
            {!!pets.length && (
                <div class="m-16">
                    ...
                    <div class="grid md:grid-cols-2">
                        {pets.map(pet => {
                            return (
                                <div class="bg-third text-white h-12 rounded-xl pl-10 pt-2 flex flex-row space-x-96 border border-2 border-third hover:bg-orange-700 hover:border-orange-700 cursor-pointer mt-5 w-fit pr-10" onClick={(e) => goTo(e, pet.id)}>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 fill-red-900 stroke-current" onClick={(e) => delPet(e, pet.id)}>
