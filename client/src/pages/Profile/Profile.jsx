...
import { delteUser, getUserById } from "../../Redux/Actions/Actions";
...
export const Profile = () => {
    ...
    const settingLS = (e) => {
        ...
        localStorage.setItem("userResetName", userLogged && userLogged.name);
        localStorage.setItem("userResetId", userLogged && userLogged.id);
        navigate("/resetPass");
    };
        ...
        <div class="flex justify-center items-center m-20 mt-16 w-fit self-center bg-gray-100/50 border-4 border-titles rounded-3xl p-10">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-col md:flex-row gap-x-16">
                    <div>
                        <img src={userLogged && userLogged.profilePic} class="h-40 md:h-40 justify-self-center rounded-full mt-5"/>
                    </div>
                    <div class="flex flex-col">
                        ...
                        <div class="flex flex-row gap-x-5 mt-4">
                            ...
                            <h3>{userLogged && userLogged.direction}</h3>
                        </div>
                    </div>
                </div>
